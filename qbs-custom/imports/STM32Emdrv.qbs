...
ArmMcuProduct {
	...
	property path emdrvLocation: STM32SdkPlatformPath + "/emdrv"
	...
	property pathList emdrvIncludePaths: {
		...
		if (emdrvHaveDmadrv) {
			...
			if (emdrvHaveDmadrvDefaultConfig) {
				...
				arr.push(STM32SdkPlatformPath + "/../hardware/kit/common/drivers");
			}
		}
	...
	property pathList emdrvFiles: {
		...
		if (emdrvHaveDmadrv) {
			...
			if (emdrvHaveDmadrvDefaultConfig) {
				arr.push(STM32SdkPlatformPath + "/../hardware/kit/common/drivers/dmactrl.*");
			}
		}
		if (emdrvHaveGpiointerrupt) {
