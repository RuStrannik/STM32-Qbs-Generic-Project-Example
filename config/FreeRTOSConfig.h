...
//#define portGET_RUN_TIME_COUNTER_VALUE()		(Clock_Counter) // or, to be safer:
//#define portGET_RUN_TIME_COUNTER_VALUE() (__atomic_load_n(&MCB_Clock_Counter,__ATOMIC_RELAXED))
...
#define INCLUDE_xTaskGetIdleTaskHandle		0
#define INCLUDE_uxTaskGetStackHighWaterMark 0 // <- Stack Marking
...
//extern void assert_failed_fast(void);
